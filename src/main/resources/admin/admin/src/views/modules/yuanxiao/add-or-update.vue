<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="院校" prop="yuanxiao">
					<el-input v-model="ruleForm.yuanxiao" placeholder="院校" clearable  :readonly="ro.yuanxiao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="院校" prop="yuanxiao">
					<el-input v-model="ruleForm.yuanxiao" placeholder="院校" readonly></el-input>
				</el-form-item>
			</template>
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='yuanxiao'){
							this.ruleForm.yuanxiao = obj[o];
							this.ro.yuanxiao = true;
							continue;
						}
				}
