		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"100%","margin":"0 0 20px","flexWrap":"wrap","display":"flex"}' :inline="true" :model="searchForm">
				<el-row :style='{"width":"100%","display":"block","order":"2"}' >
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}' class="select" label="课程名称" prop="kechengmingcheng">
						...
						<el-select  @change="kechengmingchengChange" clearable v-model="searchForm.kechengmingcheng" placeholder="请选择课程名称">
							<el-option v-for="(item,index) in kechengmingchengOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
				...
				<el-row :style='{"width":"100%","padding":"0","margin":"20px 0 20px","background":"none","display":"flex"}'>
					<el-button :style='{"border":"1px dotted #a347ea","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#a347ea","borderRadius":"0px","background":"#f3eafa","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('xueshengchengji','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"1px dotted #df2543","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#df2543","borderRadius":"0px","background":"#fcecef","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('xueshengchengji','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"1px solid #a347ea","cursor":"pointer","padding":"0 16px","margin":"3px 6px 3px 0","outline":"none","color":"#a347ea","borderRadius":"20px","background":"#f3eafa","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('xueshengchengji','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"1px solid #1fbfae","cursor":"pointer","padding":"0 16px","margin":"3px 6px 3px 0","outline":"none","color":"#1fbfae","borderRadius":"20px","background":"#e9faf8","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('xueshengchengji','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>





							<el-button :style='{"border":"1px solid #dc333b","cursor":"pointer","padding":"0 16px","margin":"3px 6px 3px 0","outline":"none","color":"#dc333b","borderRadius":"20px","background":"#fbeced","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('xueshengchengji','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
