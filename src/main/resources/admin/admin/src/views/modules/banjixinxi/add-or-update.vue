<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="班级名称" prop="banjimingcheng">
					<el-input v-model="ruleForm.banjimingcheng" placeholder="班级名称" clearable  :readonly="ro.banjimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="班级名称" prop="banjimingcheng">
					<el-input v-model="ruleForm.banjimingcheng" placeholder="班级名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="班级人数" prop="banjirenshu">
					<el-input v-model="ruleForm.banjirenshu" placeholder="班级人数" clearable  :readonly="ro.banjirenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="班级人数" prop="banjirenshu">
					<el-input v-model="ruleForm.banjirenshu" placeholder="班级人数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="select" v-if="type!='info'"  label="院校" prop="yuanxiao">
					<el-select :disabled="ro.yuanxiao" v-model="ruleForm.yuanxiao" placeholder="请选择院校" >
						<el-option
							v-for="(item,index) in yuanxiaoOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="院校" prop="yuanxiao">
					<el-input v-model="ruleForm.yuanxiao"
						placeholder="院校" readonly></el-input>
				</el-form-item>
